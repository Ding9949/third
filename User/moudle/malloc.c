...
malloc_dev_t mallco_dev;

#endif

void malloc_init(void)
{
	mallco_dev.init = mem_init;
	mallco_dev.perused = mem_perused;
	mallco_dev.membase[SRAMIN] = mem1base;
	mallco_dev.memmap[SRAMIN] = mem1mapbase;
	mallco_dev.memrdy[SRAMIN] = 0;
	mallco_dev.membase[SRAMEX] = mem2base;
	mallco_dev.memmap[SRAMEX] = mem2mapbase;
